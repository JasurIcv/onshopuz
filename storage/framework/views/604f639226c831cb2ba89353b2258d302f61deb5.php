...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <?php endif; ?>
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="<?php echo e(route('register')); ?>" style="margin-left: 20px">
                        <?php echo e(__('Registor')); ?>

                    </a>
                <?php endif; ?>
                <a href="<?php echo e(route('google.redirect')); ?>" class="ml-4" >
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH D:\OpenServer\domains\onshopuz\resources\views/auth/login.blade.php ENDPATH**/ ?>